...
print(time.ctime())
main_dir = "C:/Users/bcp17/Google Drive/THE RAGDOLLS_ 590 Big Data/CER_Data/CER Electricity Revised March 2012"
root = main_dir + "/UnzippedData"
...
df_time_correction = pd.read_csv(main_dir + "/timeseries_correction.csv",
    sep = ',', parse_dates=[1])
